  ...
  do ->
    ...
    args = (unnamed-params-descriptors = [], named-params-descriptors = [], optional-params-descriptors = [], param-descriptions = {}) ->
      ...
      do !->
        ...
        for reference-name in optional-reference-names
      ...
      if argc <= mandatory-count
        ...
        errln "Not enough parameters given.\n"
        show-usage!
        fail!
